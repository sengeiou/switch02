...
import com.szip.jswitch.Util.IMapUtil;
...
public class OnfootFragment extends BaseFragment implements OnMapReadyCallback {
    ...
    private void makeLine(){
        Log.d("DATA******","latArray = "+sportData.latArray+" ;lngArray = "+sportData.lngArray);
