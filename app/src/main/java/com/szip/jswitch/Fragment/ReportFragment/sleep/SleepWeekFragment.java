...
public class SleepWeekFragment extends BaseFragment implements View.OnClickListener{
    ...
    private void initData() {
        reportDataBean = LoadDataUtil.newInstance().getSleepWithWeek(((ReportActivity)getActivity()).reportDate);
    }
