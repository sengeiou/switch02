...
import com.szip.jswitch.Activity.PrivacyActivity;
...
public class MyAlerDialog {
    ...
    public AlertDialog showAlerDialogForBodyFat(String title, String msg,float weight, boolean cancelable,
                                      final AlerDialogOnclickListener onclickListener, Context context){
        ...
        alertDialog.show();
        Window window = alertDialog.getWindow();
        window.setContentView(R.layout.dialog_bodyfat_layout);
        TextView tv_title = window.findViewById(R.id.dialogTitle);
        tv_title.setText(title);
        TextView tv_message =  window.findViewById(R.id.msgTv);
        tv_message.setText(msg);
