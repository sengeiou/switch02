...
//    ,R.mipmap.nowwatch_29,R.mipmap.nowwatch_31,
//    R.mipmap.nowwatch_33
...
//    ,R.raw.bg36,R.raw.bg34,R.raw.bg38
    ...
    public void onUpdataView(UpdateView updateView){
        if(updateView.getState().equals("0")){//进度+1
            ...
            if (!isSendPic){
                ...
                ProgressHudModel.newInstance().showWithPie(SelectDialActivity.this,getString(R.string.diyDailing),num,
