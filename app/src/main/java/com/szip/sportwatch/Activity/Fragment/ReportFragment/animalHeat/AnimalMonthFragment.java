package com.szip.sportwatch.Activity.Fragment.ReportFragment.animalHeat;
...
public class AnimalMonthFragment extends BaseFragment implements View.OnClickListener{
    ...
    private void updateView() {
        ...
        if (DateUtil.getTimeOfToday()==((AnimalHeatActivity)getActivity()).reportDate)
            ((TextView)getView().findViewById(R.id.dateTv)).setText(DateUtil.getStringDateFromSecond(
                    ((AnimalHeatActivity)getActivity()).reportDate-27*24*60*60,"yyyy/MM/dd")+
    ...
    private void initData() {
        reportDataBean = LoadDataUtil.newInstance().getAnimalHeatWithMonth(((AnimalHeatActivity)getActivity()).reportDate);
    }
